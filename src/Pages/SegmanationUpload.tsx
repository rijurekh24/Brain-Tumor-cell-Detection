...
const SegmentationUpload: React.FC = () => {
	...
	const handleSubmit = async (event: React.FormEvent) => {
		...
		try {
			...
			const segmentation_img =
				response.data["tumor type"]?.segmentation_image;
			...
			>
				...
				>
					...
					<Typography variant="body1" sx={{ mb: 4, color: "#ddd" }}>
						Upload your brain MRI scan for analysis. Our AI-powered
						system will provide a detailed assessment.
					</Typography>
						...
						<>
							{classification === "non_brain" ? (
								<Box mt={4} p={3}>
									...
									>
										The uploaded image is not a valid brain
										MRI scan.
									</Typography>
								</Box>
							) : (
